...
8. **Sistem** membuka *Popup* atau *Infowindow* pada marker lokasi tersebut.
...
- **A1: Pencarian Berdasarkan Kategori**
    ...
    4. Sistem melakukan *fitting bounds* peta untuk mencakup seluruh marker hasil pencarian.
...
- Marker yang terpilih harus memiliki visual yang berbeda (misal: animasi *pulse* atau warna yang lebih terang).
