...
export function BannedUserGuard({ children }: { children: React.ReactNode }) {
    ...
    if (profile?.accountStatus === 'banned') {
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
                <div className="max-w-md w-full bg-surface rounded-xl shadow-lg p-8 text-center space-y-6 border-t-4 border-red-600">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-primary">Account Banned</h1>
    ...
    if (profile?.accountStatus === 'suspended') {
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
                <div className="max-w-md w-full bg-surface rounded-xl shadow-lg p-8 text-center space-y-6 border-t-4 border-orange-500">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-primary">Account Suspended</h1>
                        <p className="text-gray-500 mt-2">
